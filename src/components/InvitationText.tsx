      ...
      <div className="relative rounded-3xl royal-card p-8 text-center overflow-hidden">
        ...
        <div className="absolute top-0 left-0 right-0 h-12 pointer-events-none opacity-80 flex justify-center">
          <svg viewBox="0 0 300 40" className="w-full h-full fill-[#8B1E3F]">
            ...
            <circle cx="120" cy="15" r="3" fill="#C48B9F" />
            <circle cx="180" cy="15" r="3" fill="#C48B9F" />
          </svg>
        </div>

        {/* Heart Divider */}
        <div className="flex justify-center items-center gap-2 mb-6 mt-2 text-[#8B1E3F]">
          <div className="w-12 h-[1px] bg-[#C48B9F]"></div>
        ...
        <div className="space-y-4 font-serif-title text-lg sm:text-xl text-[#3D0914] leading-relaxed">
          <p>
            Сиздерди балдарыбыз <span className="font-bold text-[#8B1E3F] text-2xl sm:text-3xl font-serif-title border-b-2 border-[#C48B9F]">Канатбек</span> менен <span className="font-bold text-[#8B1E3F] text-2xl sm:text-3xl font-serif-title border-b-2 border-[#C48B9F]">Бактыгүлдүн</span> үйлөнүү үлпөт тоюна арналган салтанатка келип, кадырлуу коногубуз болууга чакырабыз!
          </p>
        </div>

        {/* September 2026 Calendar Strip (matching video 00:11) */}
        <div className="mt-10 pt-6 border-t border-[#C48B9F]/30">
          ...
          <div className="grid grid-cols-7 gap-1 text-center font-serif-title text-sm font-semibold text-[#3D0914]">
            ...
            {septemberDays.map((day) => {
              ...
              return (
                ...
                >
                  {isWeddingDay ? (
                    <div className="relative flex items-center justify-center w-8 h-8 rounded-full bg-[#8B1E3F] text-[#FFF7F4] font-bold shadow-md animate-pulse">
                      <span>12</span>
                      <Heart className="absolute -top-1 -right-1 w-3.5 h-3.5 fill-[#C48B9F] text-[#C48B9F]" />
                    </div>
                  ) : (
